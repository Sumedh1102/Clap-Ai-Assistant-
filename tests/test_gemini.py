...
class AdapterTest(unittest.TestCase):
    ...
    def test_error_mapping(self):
        ...
        cases = [
            ...
            (err(401, "UNAUTHENTICATED", "API keys are not supported by this API. Expected OAuth2 access token",
                 [{"@type": "type.googleapis.com/google.rpc.ErrorInfo", "reason": "API_KEY_SERVICE_BLOCKED"}]),
             "cannot be used with the Gemini API"),
            (err(401, "UNAUTHENTICATED", "Request had invalid authentication credentials. Expected OAuth 2 access token",
                 [{"@type": "type.googleapis.com/google.rpc.ErrorInfo", "reason": "ACCESS_TOKEN_TYPE_UNSUPPORTED"}]),
             "cannot be used with the Gemini API"),
            (err(403, "PERMISSION_DENIED", "Generative Language API has not been used in project 1 before or it is disabled.",
                 [{"@type": "type.googleapis.com/google.rpc.ErrorInfo", "reason": "SERVICE_DISABLED"}]),
             "not enabled for this key's Google Cloud project"),
            (err(401, "UNAUTHENTICATED", "Request had invalid authentication credentials."), "key was rejected"),
